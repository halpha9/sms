...
const Home = () => {
  ...
  console.log(data && data.chat_session);
  console.log(claims && claims!["x-hasura-user-id"]);
    ...
    <div className="h-full">
      ...
      {state.openSession && (
        <motion.div
          ...
          className="h-full bg-slate-800 flex-1"
        >
          {state.currentSession && (
            <div className="flex flex-col flex-auto h-full p-6 scroll-m-0">
              <div className="flex flex-col flex-auto flex-shrink-0 rounded-2xl  h-full p-4">
                ...
                <div className="flex flex-row items-center h-16 rounded-xl border border-slate-600 bg-slate-800 w-full px-4">
                  <div>
